	...
	protected boolean mergeItemStack(ItemStack itemStack, int startSlotNum, int endSlotNum, boolean checkBackwards)
	{
		...
		if (itemStack.isStackable())
		{
			while (itemStack.stackSize > 0 && (!checkBackwards && k < endSlotNum || checkBackwards && k >= startSlotNum))
			{
				...
				if (itemstack1 != null && itemstack1.itemID == itemStack.itemID && (!itemStack.getHasSubtypes() || itemStack.getItemDamage() == itemstack1.getItemDamage()) && ItemStack.areItemStackTagsEqual(itemStack, itemstack1) && slot.isItemValid(itemStack))
				{
